...
public class ChoosingTranslationSceneController extends TestingController {
    ...
    private void getAnswerOptions(){
        ...
        int answerOptionsNumber = ANSWER_OPTIONS_MAX_NUMBER;
        if(currentCollection.getPhrasesNumber() < ANSWER_OPTIONS_MAX_NUMBER){
            answerOptionsNumber = currentCollection.getPhrasesNumber();
        }
    ...
    protected void validateUserAnswer() {
        ...
        if(currentPhrase.getPhrase().toLowerCase().equals(selectedAnswerOption)){
